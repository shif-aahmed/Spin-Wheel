...
import { updateQuickResults } from './HeaderWithResults';
...
const Wheel = ({
  ...
  const applauseRef = useRef(null); // ✅ NEW
  ...
  const spinWheel = () => {
    ...
    const winnerIndex = riggedWinnerIndex.current ?? Math.floor(Math.random() * currentData.length);
